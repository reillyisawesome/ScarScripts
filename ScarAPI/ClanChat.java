...
//
//		Example use: ClanChat.hopTo("Player"); - Hops to Player
//					 ClanChat.addFriend("Player"); - Add's Player
//					 ClanChat.kick("Player"); - Kicks Player from ClanChat
//					 ClanChat.getPlayerList(); - Grabbing all players in clan chat as String[]
//					 ClanChat.hasPlayer("Player"); -  Checks if Player is in CC
//					 ClanChat.getPlayerWorld("Player"); - Grab Player World
//					 ClanChat.getPlayerRank("Player"); - Grab Players Rank
//					 ClanChat.join("Player"); - Join a CC
//					 ClanChat.leave(); - Leave's CC
//					 ClanChat.openTab(); - Open CC Tab
//					 ClanChat.isTabOpen(); - Checks if CC Tab is Open
//					 ClanChat.getTitle(); - Get's Title of CC
//					 ClanChat.getOwner(); - Grabs Owner of CC
//
//
